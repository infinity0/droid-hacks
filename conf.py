...
BLOG_AUTHOR = "Ximin Luo"  # (translatable)
BLOG_TITLE = "Android FOSS+H hacks"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://infinity0.github.io/droid-hacks/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "infinity0@pwned.gg"
BLOG_DESCRIPTION = "A collection of hacks to free your Android device"  # (translatable)
